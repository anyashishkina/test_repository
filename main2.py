...
def callback_worker(call):
    ...
    if call.data == "manager" or "boss":
        if call.data == "manager":
            bot.send_message(call.message.chat.id, 'Если у вас есть руководитель, зарегистрированный в системе "Тренажёр по продажам", введите пожалуйста его username, если нет-введите "-"')
